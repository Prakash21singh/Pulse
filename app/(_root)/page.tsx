export default function Home() {
  return (
    <div className="w-full p-3 h-full flex-center">
      {/* <h1 className="text-3xl font-bold">Track With Pulse</h1> */}
      <div className="relative w-[600px] h-[250px] rounded-lg p-0.5 bg-gradient-radial from-white to-[#0c0d0d]">
        ...
        <div className="relative flex flex-col items-center justify-center w-full h-full bg-gradient-radial from-[#444444] to-[#0c0d0d] border border-[#202222] rounded-[9px] text-white">
          ...
          <div className="font-bold text-4xl bg-gradient-to-r from-black to-white bg-clip-text text-white-2/80">
            Pulse
          </div>
          <p className="text-base font-semibold text-white-2/30">
            The Next Way to Track Progress
          </p>
          <div className="absolute w-full h-[1px] top-[10%] bg-gradient-to-r from-gray-600 to-[#1d1f1f]"></div>
          <div className="absolute w-full h-[1px] bottom-[10%] bg-[#2c2c2c]"></div>
          <div className="absolute h-full w-[1px] left-[5%] bg-gradient-to-b from-gray-500 to-[#222424]"></div>
